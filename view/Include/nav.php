    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto text-center">
            <li class="nav-item active">
                <a class="nav-link" href="index.php?action=listArticles">Tous les chapitres
            ...
            <?php if ($this->isConnected) {  ?>
                <li class="nav-item">
                    <a class="nav-link text-nav" href="index.php?action=profil">
                        <span><i class="fas fa-user">&nbsp;</i></span>Votre profil
                    </a>
                </li>

                <li class="nav-item">
                    <a class="btn btn-outline-danger my-2 my-sm-0 text-nav" href="index.php?action=logout">
                        <span><i class="fas fa-sign-out-alt"></i></span> &nbsp;Se déconnecter
                    </a>
                </li>
            <?php } else { ?>
                <li class="nav-item">
